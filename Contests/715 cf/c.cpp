...
int help(vec<2,int> &dp,vec<1,int> &arr,int l,int r){
	//db2(l,r);
	if(l>=r) return 0;
	if(dp[l][r]!=-1) return dp[l][r];

	return dp[l][r]=arr[r]-arr[l]+ min(help(dp,arr,l+1,r),help(dp,arr,l,r-1));
}
